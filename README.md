...
- **Light/dark themes** with 9 color palettes (Default, Nord, Ocean, Forest, Sunset, Rose, Slate, Mocha, Kitchen Paper) — auto-switch by fixed hours or local sunrise/sunset. Kitchen Paper adds a warm-domestic paper aesthetic (cream background, pastel event pills with colored left border, dashed dividers, a colored halo around today's cell, and a subtle paper-grain texture)
